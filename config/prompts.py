...
Требования:
- title: Официальное название для Plex (TVDB/TMDB совместимое)
...
- "Attack on Titan" (не "Shingeki no Kyojin")
- "Frieren Beyond Journeys End" (не "Frieren.Beyond.Journeys.End")
- "The Mandalorian" (не "Mandalorian.The")"""
